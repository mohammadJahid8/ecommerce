...
const ProductItem = (props: ProductItemProps) => {
  ...
  return (
    <div className='flex flex-col cursor-pointer flex-shrink-0 w-full min-w-[280px] md:w-[calc((100%-48px)/3)] lg:w-[calc((100%-72px)/4)] xl:w-[calc((100%-96px)/5)]'>
      {/* Product Image Container */}
      <div className='relative flex justify-center items-center w-full h-[280px] bg-[#f9f9f9] rounded-[28px] dark:bg-[#202124] overflow-hidden group border border-transparent hover:border-gray-200 dark:hover:border-gray-700 transition-all duration-300'>
        {/* New Badge */}
        {showNewBadge && (
        ...
        <Image
          className='transition ease-in-out duration-300 group-hover:scale-105 object-contain p-0 w-full h-full'
          unoptimized={true}
      ...
      <div className='mt-6 flex flex-col'>
        ...
        <div className='flex items-center mt-10 cursor-pointer group/buy'>
          ...
          <ChevronRight size={20} className='text-[#1a73e8] dark:text-[#8ab4f8] ml-0.5' />
        </div>
      </div>
    </div>
  );
