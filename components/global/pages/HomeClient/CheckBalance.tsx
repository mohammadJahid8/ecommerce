  ...
  return (
    <>
      <button
        ...
        className='px-3 bg-[#1967D2] text-white rounded-md w-full lg:w-auto h-10 whitespace-nowrap font-medium text-xs md:text-sm transition-all duration-300 hover:shadow-[0_4px_10px_rgba(0,0,0,0.3)]'
      >
        {t('check_balance')}
      </button>
