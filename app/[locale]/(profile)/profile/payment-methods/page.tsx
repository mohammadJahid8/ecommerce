...
import EditPaymentMethodDialog from "@/components/profile/EditPaymentMethodDialog";
...
import { ArrowLeft, MessageSquare, Pencil, Trash2, Type } from "lucide-react";
...
export default function PaymentMethodsPage() {
  ...
  // Keep selectedMethod in sync when paymentMethods updates (e.g. after edit)
  useEffect(() => {
    if (selectedMethod) {
    ...
    <>
      ...
      <div className="min-h-screen bg-[#f0f4f9] dark:bg-[#1f1f1f]">
        <div
          className={
            selectedMethod
              ? "max-w-[1050px] mx-auto p-4 md:p-8 flex flex-col min-h-[calc(100vh-80px)] justify-center"
              : "max-w-[950px] mx-auto p-4 md:p-8"
          }
        >
          {/* ─── DETAIL VIEW ─── */}
          {selectedMethod ? (
                      ...
                      >
                        ...
                        <g transform="translate(100, 96) rotate(-12)">
                          ...
                          <rect
                            ...
                            height="3"
                            rx="1.5"
                            className="fill-[#a8c4f5] dark:fill-[#5a7ab8]"
                          />
                          <rect
                            x="-16"
                            y="-14"
                            ...
                            height="3"
                            rx="1.5"
                            className="fill-[#bdd0f7] dark:fill-[#4d6da8]"
                          />
                          <rect
                            x="-16"
                            y="-6"
                          ...
                          <rect
                            ...
                            height="3"
                            rx="1.5"
                            className="fill-[#cddaf5] dark:fill-[#445e98]"
                          />
                          <rect
                            x="-16"
                            y="10"
                        ...
                        <g transform="translate(118, 118) rotate(-50)">
                          ...
                          <rect
                            ...
                            height="24"
                            rx="1.5"
                            className="fill-[#7baaf7] dark:fill-[#6d9de8]"
                          />
                          {/* Pen grip ring */}
                          <rect
                            x="-3"
                            ...
                            height="3"
                            rx="1"
                            className="fill-[#5b8ed4] dark:fill-[#4a7cc0]"
                          />
                          {/* Pen tip */}
                          <path
                            d="M-2.5 -5 L0 3 L2.5 -5Z"
